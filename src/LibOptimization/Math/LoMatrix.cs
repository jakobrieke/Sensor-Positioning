    ...
    public class LoMatrix : List<List<double>>
    {
        ...
        public static LoMatrix operator +(LoMatrix ai_source, LoMatrix ai_dest)
        {
            if (IsSameDimension(ai_source, ai_dest) == false)
                throw new LoException(LoException.Series.DifferRowNumberAndCollumnNumber);
        ...
        public static LoVector operator +(LoMatrix ai_source, LoVector ai_dest)
        {
            if (IsComputableMatrixVector(ai_source, ai_dest) == false)
                throw new LoException(LoException.Series.NotComputable);
        ...
        public static LoMatrix operator *(LoMatrix ai_source, LoMatrix ai_dest)
        {
            ...
            throw new LoException(LoException.Series.NotComputable, "Matrix * Matrix");
        }
        ...
        public static LoVector operator *(LoMatrix mat, LoVector vec)
        {
            ...
            if (mat.ColCount != vec.Count)
                throw new LoException(LoException.Series.NotComputable, "Matrix * Vector - size error");
        ...
        public static LoVector operator *(LoVector vec, LoMatrix mat)
        {
            ...
            if (vec.Count != mat.RowCount)
                throw new LoException(LoException.Series.NotComputable, "Vector * Matrix - size error");
        ...
        {
            if (this.RowCount != this.ColCount)
                throw new LoException(LoException.Series.NotComputable, "ToDiagonalMatrix()");
        ...
        {
            if (this.RowCount != this.ColCount)
                throw new LoException(LoException.Series.NotComputable, "ToVectorFromDiagonal");
        ...
        public LoVector ToVector()
        {
            ...
            throw new LoException(LoException.Series.NotComputable, "Matrix");
        }
        ...
        public LoMatrix Cholesky()
        {
            if (this.IsSquare() == false)
                throw new LoException(LoException.Series.NotComputable, "Cholesky() not Square");
