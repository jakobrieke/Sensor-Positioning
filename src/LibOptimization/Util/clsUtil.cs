...
namespace Util
{
  ...
  public class clsUtil
  {
    ...
    public static void RandomizeArray(ref List<clsPoint> arPoint)
    {
      // Fisher–Yates shuffle
      int n = arPoint.Count;
      while (n > 1)
    ...
    /// <remarks></remarks>
    public static void DebugValue(List<clsPoint> ai_results)
    {
    ...
    /// <returns></returns>
    /// <remarks></remarks>
    public static bool IsCriterion(double ai_eps, clsPoint ai_comparisonA,
      clsPoint ai_comparisonB, double ai_tiny = 0.0000000000001)
    {
    ...
    /// <remarks></remarks>
    public static void ToCSV(clsPoint arP)
    {
    ...
    /// <param name="arP"></param>
    /// <remarks></remarks>
    public static void ToCSV(IEnumerable<clsPoint> arP)
    {
    ...
    /// <param name="arP"></param>
    /// <remarks></remarks>
    public static void ToEvalList(List<clsPoint> arP)
    {
    ...
    /// <returns></returns>
    /// <remarks></remarks>
    public static List<clsEval> GetSortedEvalList(List<clsPoint> arP)
    {
    ...
    /// <returns></returns>
    /// <remarks></remarks>
    public static clsPoint GetBestPoint(List<clsPoint> ai_points,
      bool isCopy = false)
    {
      if (ai_points == null)
    ...
    /// <returns></returns>
    /// <remarks></remarks>
    public static int FindCurrentIndex(List<clsPoint> ai_points)
    {
      var bestIndex = 0;
    ...
    /// <remarks></remarks>
    public static void LimitSolutionSpace(clsPoint temp, double[] LowerBounds,
      double[] UpperBounds)
    {
    ...
    /// <returns></returns>
    public static bool IsExistZeroLength(clsPoint[] points)
    {
      // var isCanCrossover = true;
      clsEasyVector vec /* TODO Change to default(_) if this is not a reference type */;
    ...
    /// <param name="p"></param>
    /// <returns></returns>
    public static bool CheckOverflow(clsPoint p)
    {
      foreach (var v in p)
      {
    ...
    /// <returns></returns>
    public static bool CheckOverflow(IEnumerable<clsPoint> listP)
    {
    ...
    public static void SetInitialPoint2(List<clsPoint> pupulation,
    ...
    /// <returns></returns>
    public static clsEasyMatrix ToConvertMat(List<clsPoint> results)
    {
      var row = results.Count;
      var col = results[0].Count;
      var ret = new clsEasyMatrix(row, col);
    ...
    /// <returns></returns>
    public static double Average(clsEasyVector vec)
    {
      var ret = 0.0;
