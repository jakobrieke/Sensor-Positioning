...
namespace LibOptimization.Optimization
{
    ...
    public class clsOptNewtonMethod : absOptimization
    {
        ...
        public override bool DoIteration(int iteration = 0)
        {
            ...
            // Do Iterate
            clsEasyVector grad = new clsEasyVector(base.m_func.NumberOfVariable(), clsEasyVector.VectorDirection.Col);
            clsEasyMatrix h = new clsEasyMatrix();
            ...
            for (int iterate = 0; iterate <= iteration; iterate++)
            {
                ...
                h.RawMatrix = this.m_func.Hessian(this.m_vect);
