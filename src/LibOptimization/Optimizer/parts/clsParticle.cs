...
namespace LibOptimization.Optimization
{
    ...
    {
        private clsPoint m_point;
        private clsPoint m_bestPoint;
        ...
        ///         ''' <remarks></remarks>
        public clsParticle(clsPoint ai_point, double[] ai_velocity, clsPoint ai_bestPoint)
        {
