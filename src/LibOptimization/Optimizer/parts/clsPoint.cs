...
namespace LibOptimization.Optimization
{
  ...
  /// </summary>
  /// <remarks></remarks>
  public class clsPoint : clsEasyVector, IComparable
  {
    ...
    /// <remarks></remarks>
    public clsPoint(clsPoint ai_vertex)
    {
    ...
    /// <remarks></remarks>
    public clsPoint(absObjectiveFunction ai_func)
    {
      m_func = ai_func;
    ...
    /// <param name="ai_vars"></param>
    /// <remarks></remarks>
    public clsPoint(absObjectiveFunction ai_func, IEnumerable<double> ai_vars)
    {
      m_func = ai_func;
      AddRange(ai_vars);
      m_evaluateValue = m_func.F(this);
    ...
    /// <remarks></remarks>
    public clsPoint(absObjectiveFunction ai_func, int ai_dim)
    {
      m_func = ai_func;
    ...
    public int CompareTo(object ai_obj)
    {
      ...
      // Compare
      var mineValue = Eval;
      var compareValue = ((clsPoint) ai_obj).Eval;
    ...
    /// <remarks></remarks>
    public void CopyFrom(clsPoint ai_point)
    {
