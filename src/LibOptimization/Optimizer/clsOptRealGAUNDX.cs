...
namespace LibOptimization.Optimization
{
    ...
    public class clsOptRealGAUNDX : absOptimization
    {
        ...
        ///         ''' <remarks></remarks>
        private int SelectRoulette(List<clsPoint> ai_chidren, bool isForMinimize)
        {
        ...
        ///         ''' <returns></returns>
        ///         ''' <remarks></remarks>
        private List<clsPoint> UNDX(clsPoint p1, clsPoint p2, clsPoint p3)
        {
            // calc d
            ...
            // UNDX
            List<clsPoint> children = new List<clsPoint>(ChildrenSize);
            var g = (p1 + p2) / 2.0;
            ...
            var t = new clsEasyVector(ObjectiveFunction.NumberOfVariable());
            for (int genChild = 0; genChild <= System.Convert.ToInt32(ChildrenSize / (double)2 - 1); genChild++)
            {
                ...
                // overflow check
                var temp1 = new clsPoint(ObjectiveFunction, child1);
                ...
                var temp2 = new clsPoint(ObjectiveFunction, child2);
